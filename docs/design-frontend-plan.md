...
- [QNT-132](https://linear.app/noahwins/issue/QNT-132/expose-subsystem-provenance-via-apiv1health-for-data-driven-ui) — expose subsystem provenance via `/api/v1/health` (Backlog, Medium). Triggered by the SOURCES/JOBS/SENTIMENT/AGENT strip in the middle pane.
